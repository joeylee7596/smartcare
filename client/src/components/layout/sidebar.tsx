...
export function Sidebar() {
  ...
  return (
    <div
      className={cn(
        "flex flex-col transition-all duration-300 bg-gradient-to-b from-[#1E2A4A] via-[#111827] to-[#1F2937] rounded-tr-[2rem] shadow-2xl relative h-screen",
        "before:absolute before:inset-0 before:bg-gradient-to-b before:from-blue-500/5 before:to-transparent before:rounded-tr-[2rem] before:pointer-events-none",
